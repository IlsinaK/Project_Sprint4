...
public class MainPage {
    private static final String FAQ_ANSWER_PATTERN = ".//div[contains(@class, 'accordion__item') and contains(text(), '%s')]";;
    protected WebDriver driver;

    private By orderTopButton = By.xpath(".//div[@class='Header_Nav__AGCXC']//button[text()='Заказать']");
    public By orderMiddleButton = By.xpath(".//button[contains(@class, 'Button_Middle__1CSJM')]");
    ...
    public static final String DELIVERY_MKAD = "Я живу за МКАДом, привезёте?";
